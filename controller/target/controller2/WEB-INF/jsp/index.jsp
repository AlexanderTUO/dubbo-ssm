					...
					<!-- Row start -->
						<div class="am-u-md-3">
							<div class="card-box widget-user">
                                <div>
                                    <img src="/static/img/avatar-3.jpg" class="img-responsive img-circle" alt="user">
						...
						<div class="am-u-md-3">
							<div class="card-box widget-user">
                                <div>
                                    <img src="/static/img/avatar-2.jpg" class="img-responsive img-circle" alt="user">
                                    <div class="wid-u-info">
                                        <h4 class="m-t-0 m-b-5 font-600">Chadengle</h4>
                                        <p class="text-muted m-b-5 font-13">coderthemes@gmail.com</p>
						...
						<div class="am-u-md-3">
							<div class="card-box widget-user">
                                <div>
                                    <img src="/static/img/avatar-4.jpg" class="img-responsive img-circle" alt="user">
                                    <div class="wid-u-info">
                                        <h4 class="m-t-0 m-b-5 font-600">Chadengle</h4>
                                        <p class="text-muted m-b-5 font-13">coderthemes@gmail.com</p>
						...
						<div class="am-u-md-3">
							<div class="card-box widget-user">
                                <div>
                                    <img src="/static/img/avatar-10.jpg" class="img-responsive img-circle" alt="user">
                                    <div class="wid-u-info">
                                        <h4 class="m-t-0 m-b-5 font-600">Chadengle</h4>
                                        <p class="text-muted m-b-5 font-13">coderthemes@gmail.com</p>
								...
								<div class="inbox-widget nicescroll" style="height: 315px; overflow: hidden; outline: none;" tabindex="5000">
                                    <a href="#">
                                        <div class="inbox-item">
                                            <div class="inbox-item-img"><img src="/static/img/avatar-1.jpg" class="img-circle" alt=""></div>
                                    ...
                                    <a href="#">
                                        <div class="inbox-item">
                                            <div class="inbox-item-img"><img src="/static/img/avatar-2.jpg" class="img-circle" alt=""></div>
                                    ...
                                    <a href="#">
                                        <div class="inbox-item">
                                            <div class="inbox-item-img"><img src="/static/img/avatar-10.jpg" class="img-circle" alt=""></div>
                                    ...
                                    <a href="#">
                                        <div class="inbox-item">
                                            <div class="inbox-item-img"><img src="/static/img/avatar-4.jpg" class="img-circle" alt=""></div>
                                    ...
                                    <a href="#">
                                        <div class="inbox-item">
                                            <div class="inbox-item-img"><img src="/static/img/avatar-5.jpg" class="img-circle" alt=""></div>
